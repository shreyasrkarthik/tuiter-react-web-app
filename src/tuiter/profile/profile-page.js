        ...
        <div>
            <div className="row">
                <div className="col-11">
                    <div className="wd-font-color-white fw-bold wd-title-font-size" >{profileData["name"]}</div>
                    <div className="wd-font-color-grey pb-2">{profileData["numberOfTuits"]} Tweets</div>
                </div>
            </div>
            ...
            <div className="col-sm-3 avatar-container">
                <img src="./images/tesla.png" className="rounded-circle profile-avatar" alt="User avatar"/>
            </div>
            ...
            <div className="wd-font-color-white fw-bold wd-title-font-size pt-5" >{profileData["name"]}</div>
