const PostItem = (post) => {
    return(`
        <div>
            <div class="row border-bottom border-top border-start border-end">
                <div class="col-2">
                ...
                <div class="col-10">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3 wd-navbar"><a class="wd-hyperlink-grey wd-float-left" href="#"><i class="fa fa-heart wd-heart-icon"></i>${post.likesCount}</a></div>
